...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-white dark:bg-gray-900">
  <head>
    ...
    <script src="https://kit.fontawesome.com/ca87a842be.js" crossorigin="anonymous"></script>
        ...
        <main class="flex-1">
          <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              <h1 class="text-2xl font-semibold text-gray-900">@lang('pages.' . (request()->pageSlug ?: 'welcome'))</h1>
            </div>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              @yield('content')
            </div>
